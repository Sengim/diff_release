...
class ReadAESHD:
    ...
    def __init__(self, n_profiling, n_validation, n_attack, target_byte, leakage_model, file_path, first_sample=0, number_of_samples=1250):
        self.name = "aes_hd"
        ...
        self.round_key = self.get_last_round_key("2b7e151628aed2a6abf7158809cf4f3c")
